...
function About() {
  return (
    ...
    <div id="info">
      ...
      <div className="about-me-image" data-aos="fade-left" data-aos-offset="20" data-aos-delay="100" data-aos-duration="3000">
        <img src="assets\images\Rehan.jpeg" alt="Me" className="floating-animation" />
      </div>

      <div className="about-text" data-aos="fade-right" data-aos-offset="200" data-aos-delay="100" data-aos-duration="2000">
        <h2>Greetings,</h2>
        <p>I am <em className="keywords">Rehan Abbas</em>, a recent graduate with a Bachelor's degree in Computer Science and Engineering (2023),
           achieving a noteworthy CGPA of <em className="keywords">7.7/10</em>. Specializing as a <em className="keywords">full-stack web developer</em>, 
